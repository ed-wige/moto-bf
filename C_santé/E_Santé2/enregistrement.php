...
<body>
    <div class="card text-center">
        ...
        ?>
        <br>
        <form method="post" action="test.php" enctype="multipart/form-data" data-toggle="validator" id="frm">
                    ...
                    <div class="form-group col-md-6">
                      ...
                      <input type="number" name="telephone" maxlength="8" class="form-control" id="inputtext"   pattern="[0-9]{2}[0-9]{2}[0-9]{2}[0-9]{2}" required>
                        ...
                        <div class="form-row">
                            ...
                            <input type="number" name="telephone_mdcin" maxlength="8" class="form-control" id="inputtext"   pattern="[0-9]{2}[0-9]{2}[0-9]{2}[0-9]{2}" required>
                          </div>
                        </div>
                         <br>
